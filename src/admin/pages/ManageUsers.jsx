                        ...
                        {users.map(user => {
                            ...
                            return(
                                <tr key={user.id} className="border-t">
                                    ...
                                    <td className="px-4 py-2"><button onClick={()=> handleonClick (user.id,user.blocked)} className="bg-blue-600 text-white p-2 rounded-md mr-2">{ user.blocked ?"Unblock":"Block"}</button></td>
                                </tr>
                            )}})}
                    </tbody>
                </table>
